...
public class Student2 extends Student1 {
	...
	public static void HienThi(Set<Student2>stdList) {
		for (Student2 str : stdList) {
	        System.out.printf("Sinh viên:%s, %d tuổi\n",str.FullName,str.Age);
	    }
	}
	public static void ThemMoi(Set<Student2> stdList) {
		Scanner sc = new Scanner(System.in);
	...
	public static void Update(Set<Student2> stdList) {
		Scanner sc = new Scanner(System.in);
	...
	public static void Delete(Set<Student2> stdList) {
	    Scanner sc = new Scanner(System.in);
