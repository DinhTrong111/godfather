...
public class Employee1 {
	...
	public static void ThemThongTin(List<Employee1> Lepl) {
		Scanner sc = new Scanner(System.in);
	...
	public static void HienTHi(List<Employee1> eplList) {
	...
	public static void Update (List<Employee1> eplList) {
		Scanner sc = new Scanner(System.in);
		System.out.println("Nhập mã nhân viên cần thay đổi:");
		 ...
		 for(int i=0;i<eplList.size();i++) {
			 if(eplList.get(i).MaNhanVien.equals(abc)) {
				 Employee1 newepl = new Employee1();
				 newepl.NhapThongTin();
	...
	public static void deLete (List<Employee1> eplList) {
